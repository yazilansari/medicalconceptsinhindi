<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="body">
				...
				<?php echo form_open("$controller/save_image",array('id'=>'save-form')); ?>
               ...
               <label for="category_id">Sub Category Name<span class="required">*</span></label>
				<div class="form-group">
                    <div class="form-line">
						<select name="sub_category_id" class="form-control" data-placeholder="Select Category" id="sub_category_id">
							<option></option>
						</select>
					</div>
				</div>
