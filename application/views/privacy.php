...
<body>
    <div class="policy_modal" style="background-color:transparent;padding:30px;padding-top: 20px;">
    ...
    <footer id="footer-main" class="container-fluid no-left-padding no-right-padding footer-main" style="margin-top:0">
        <!-- Top Footer -->
