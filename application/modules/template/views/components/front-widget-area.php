<div class="col-md-4 col-sm-4 col-xs-6 widget-area">
    <div>
        <div class="nav-side-menu widget widget_latestposts">
            <div class="widget-title"><a href="<?php echo base_url();?>text/lists">Education</a></div>
                ...
                <ul id="menu-content" class="menu-content collapse out">
                    ...
                    <ul class="sub-menu collapse" id="products_<?php echo $main->main_category_id;?>">
                        <?php if(!empty($text_data)){ foreach($text_data as $text){ if($text->main_category_id==$main->main_category_id){?>
                            <li><a href="<?php echo base_url().'text/';?><?php echo $text->sub_category_id;?>"><?php echo $text->sub_category_name.' ('.$text->total_upload_count.')';?></a></li>
                        <?php } } }?>
                    </ul>
                    <?php } }?>
                </ul>
    ...
    <aside class="widget widget_latestposts" style="margin-top:20px;">
        ...
        <div class="latest-content-box">
            <p style="line-height:20px;color:black"><?php echo substr(str_replace('\r\n', '', $app_vision[0]->app_vision),0,1000);?>
            </p>
    ...
    <aside class="widget widget_latestposts" style="margin-top:20px;">
        ...
        <div class="latest-content-box">
            <strong style="text-align:center">Vision</strong>
            <p style="line-height:20px;color:black">
            ...
            <strong style="text-align:center">Mission</strong>
            <p style="line-height:20px;color:black">
