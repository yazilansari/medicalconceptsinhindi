    ...
    <div class="type-post larg-post color-2">
        ...
        <div class="entry-cover">
            <?php if($record->thumbnail_path==''){?>
                <a href="#" target="_blank"> <img src="https://img.youtube.com/vi/4juhz8hsxMc/0.jpg" width="600" height="365" style="height: 265px !important;"></a>
            <?php } else {?>
        ...
        <div class="entry-content">
            <div class="post-category"><a href="<?php echo base_url().'post/'.$record->meta_slug;?>" title="<?php echo ucwords($record->upload_title);?>">Audio</a></div>
            ...
            <audio controls style="width: 220px !important;margin-left: -12px !important;">
                <source src="<?php echo $record->audio_path;?>">
            </audio><br>
