					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-12">
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								...
								<h2 class="title">Glucose Transporters</h2>
								<div class="dlab-post-media maigrain">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/mGRR-4LQ2Tg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
								...
								<div class="dlab-post-text text">
									...
									<h5 class="mb-2">Glucose Transporters</h5>
