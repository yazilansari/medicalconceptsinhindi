				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 allebooks">
						<div class="bookcover e-books headline">							
							...
							<?php } else { ?>
							<!-- <a href="#" class="registersubscribe" onclick="paynow('ejournal-oct-2022');">Pay Now</a> -->
							<a href="ebook/2022/Oct" class="registersubscribe">View Book</a>
							<?php } } ?>
							<div class="pdfindex">
								<?php if(!isset($_SESSION['reg_id']) && empty($_SESSION['reg_id'])) { ?>
								<p>	
									<a href="#" data-toggle="modal" data-target="#readarticle">
										<img src="images/ejournals/15-oct-2022_Page_1.jpg">												
										<img src="images/ejournals/15-oct-2022_Page_2.jpg">
									</a>									
								</p>
								<?php } else { ?>
								<p>	
