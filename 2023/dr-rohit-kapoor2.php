					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-12">
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								...
								<h2 class="title">Dr. ROHIT KAPOOR</h2>
								<div class="dlab-post-media">
									<img src="images/blog/blog-lg/rohit-kapoor2.jpg">
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<div class="readmre1"> 
									<p class="mb-2"><a href="#" class="namedr"><b>-Dr. Rohit Kapoor</b></a></p>
									<p class="mb-3 medicineed"><b class="font-22">Senior Physician And Cardiologist</b></p>
									

									<p class="mb-3">MD (Medicine), FACC (USA)</p>
									<p class="mb-3">Consultant Physician and Cardiologist</p>

									<p class="mb-3">Care Well Heart and Superspeciality Hospitals</p>
									<p class="mb-3">Amritsar</p>								
