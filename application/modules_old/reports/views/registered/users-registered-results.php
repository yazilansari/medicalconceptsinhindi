<div class="tab-content">
  ...
  <tr id="tr_<?php echo $id;?>">
    ...
    <td><?php if($record->medical_college!=''){echo $record->medical_college;} else {echo "--" ;} ?></td>
    <td><?php if($record->student_qualification!=''){echo $record->student_qualification;} else {echo "--" ;} ?></td>
