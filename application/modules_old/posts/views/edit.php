        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="input-group">
                    <div class="form-line">
                        <input type="text" id="upload_title" name="upload_title" class="form-control" autocomplete="off" maxlength="250" value="<?php if(!empty($info)){ echo $info[0]->upload_title;}?>">
                    </div>
                </div>
                ...
                <div class="input-group">
                    <div class="form-line">
                        <textarea type="text" rows="5" class="form-control" id="short_description" name="short_description"><?php if(!empty($info)){ echo $info[0]->short_description;}?> </textarea>
                    </div>
                </div>
                <label for="upload_for_user_type">Upload Data for User Type<span class="required">*</span></label>
                <div class="demo-radio-button">                    
                    <input name="upload_for_user_type" type="radio" id="radio_1" value="General" <?php if($info[0]->upload_for_user_type=='General'){echo "checked='checked'";}?>>
                    <label for="radio_1">General</label>
                    <input name="upload_for_user_type" type="radio" id="radio_2" value="Student" <?php if($info[0]->upload_for_user_type=='Student'){echo "checked='checked'";}?>>
                    <label for="radio_2">Student</label>
                    <input name="upload_for_user_type" type="radio" id="radio_3" value="Both" <?php if($info[0]->upload_for_user_type=='Both'){echo "checked='checked'";}?>>
                    <label for="radio_3">Both</label>
                </div>
                <br>            
                <label for="upload_type">Upload Type <span class="required">*</span></label>
                <div class="demo-radio-button">                    
                    <input name="upload_type" class="upload_types" type="radio" id="image" value="image" <?php if($info[0]->upload_type=='image'){echo "checked='checked'";}?>>
                    <label for="image">Image</label>
                    <input name="upload_type" class="upload_types" type="radio" id="audio" value="audio" <?php if($info[0]->upload_type=='audio'){echo "checked='checked'";}?>>
                    <label for="audio">Audio</label>
                    <input name="upload_type" class="upload_types" type="radio" id="video" value="video" <?php if($info[0]->upload_type=='video'){echo "checked='checked'";}?>>
                    <label for="video">Video</label>
                    <input name="upload_type" class="upload_types" type="radio" id="pdf" value="pdf" <?php if($info[0]->upload_type=='pdf'){echo "checked='checked'";}?>>
                    <label for="pdf">PDF</label>
                    <input name="upload_type" class="upload_types" type="radio" id="text" value="text" <?php if($info[0]->upload_type=='text'){echo "checked='checked'";}?>>
                ...
                <div id='div_video_type'>
                    ...
                    <div class="demo-radio-button">                    
                        <input name="video_type" type="radio" id="radio_71" value="inhouse" <?php if($info[0]->video_type=='inhouse'){echo "checked='checked'";}?>>
                        <label for="radio_71">In House Video</label>
                        <input name="video_type" type="radio" id="radio_72" value="youtube" <?php if($info[0]->video_type=='youtube'){echo "checked='checked'";}?>>
                ...
                <div id='div_youtube_video' style="display: none;">
                    ...
                    <div class="input-group">
                        <div class="form-line">
                            <input type="text" id="youtube_video_code" name="youtube_video_code" class="form-control" value="<?php if(!empty($info)){ echo $info[0]->youtube_video_id;}?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="input-group">
                        <div class="form-line">
                            <textarea class="form-control" id="upload_description" name="upload_description"> 
                                <?php if(!empty($info)){ echo str_replace('\r\n', '', $info[0]->upload_description);}?></textarea>
                ...
                <div id="upload_div">
                    ...
                    <div class="input-group">
                        <div class="form-line">
                            ...
                            <input type="hidden" name="upload_path_name" value="<?php if(!empty($info)){ echo $info[0]->upload_path;}?>">
                        </div>
                        <span><?php if(!empty($info)){ echo $info[0]->upload_path;}?></span>
                    </div>                    
                </div>
                ...
                <div class="input-group">
                    <div class="form-line">
                        ...
                        <input type="hidden" name="thumbnail_name" value="<?php if(!empty($info)){ echo $info[0]->upload_path;}?>">
                    </div>
                    <span><?php if(!empty($info)){ echo $info[0]->thumbnail;}?></span>
                </div>

                <label class="form-label">Upload Tags <span class="required">*</span></label>
                <div class="input-group">
                    <div class="form-line">
                        <input type="text" id="tags" name="tags" class="form-control" value="<?php if(!empty($info)){ echo $info[0]->tags;}?>">
