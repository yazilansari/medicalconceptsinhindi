					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-12">
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								...
								<h2 class="title">Dr. Ajay Kumar</h2>
								<div class="dlab-post-media">
									<img src="images/blog/blog-lg/dr-ajay-kumar.jpg">
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<div class="readmre1"> 
									<p class="mb-2"><a href="#" class="namedr"><b>-Dr Ajay Kumar</b></a></p>
									<p class="mb-2 medicineed"><b class="font-22">MBBS, MD</b></p>
									<p class="mb-3"><b>Sr Physician & Diabetologist</b> </p>

									<p class="mb-3">Diabetes Care & Research Centre,</p>
									

									<p class="mb-3">Patna</p>
