							...
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										...
										<li class="post-category">in <a href="javascript:void(0);">Role Of Growth Hormones In Promotion Of Linear Hieght </a><!--  <a href="javascript:void(0);">fashion</a> --></li>
										<li class="post-date">at <span> 22nd Feb,2020</span></li>
									</ul>
								</div>
								<h2 class="title">Role Of GH In Promotion Of Linear Hieght</h2>
								<div class="dlab-post-media">
									<img src="images/blog/blog-lg/role-gh.jpg">
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<div class="readmre1"> 
									<h5>Role Of Growth Hormones In Promotion Of Linear Hieght</h5>	
									<p>Describes How Does Growth Hormone Promotes Gain In Height In An Adolescent Child</p>
									
									<p class="mb-2"><b>Role of GH in stimulating growth</b></p>
									<p class="mb-3">GH एवं IGF-1 सम्बंधित तथ्यों को समझने के बाद आओ एक क्रम में समझते हैं कि यह linear growth को किस प्रकार बढ़ाता है। वास्तव में linear growth के लिए bony growth की आवश्यकता होगी एवं किसी bone में यह कार्य उसकी growth plate अथवा cartilaginous ends पर होता है। वास्तव में इस cartilaginous end पर होने वाली इस growth के लिए GH एवं IGF-1, दोनों की आवश्यकता होती है क्योंकि यहाँ यह दोनों एक क्रम में कार्य करते हैं। </p>

									<!-- <p class="mb-2">Clinical parameters</p>	 -->								
									<p class="mb-2">सर्वप्रथम GH, primitive chondrocytes को उत्तेजित कर, उसका differentiation करता है। इसके लिए GH, chondrocytes पर स्थित GH receptors से जुड़कर वहीँ local IGF-1 उत्पन्न करता है जो अपने paracrine action के द्वारा primitive chondrocytes को active chondrocytes में बदल देती हैं। </p>
									
									<p class="mb-4">इसके अतिरिक्त GH, hepatocytes पर स्थित GH receptors से जुड़कर IGF-1 उत्पन्न करता है जो blood में release होकर growth plate तक पहुँचती हैं। यह sytemic IGF-1 अपने endocrine action के द्वारा chondrocytes का proliferation (clonal expansion) बढ़ा देती हैं। </p>


									<p class="mb-4"> तत्पश्चात GH एवं IGF-1, T3 एवं sex steroids से सहयोग से chondrocytes के इस expanding पूल का maturation कराती हैं। </p>									
						...
						<div class="author-profile-info widget">
							<div class="author-profile-pic">	
								<a href="javascript:void(0);">
									<img src="images/pankaj-agarwal.jpg" alt="Profile Pic" width="130" height="130">
								</a>
							</div>
							<div class="author-profile-content">
								<h6 class="title">Dr. Pankaj Kumar Agarwal</h6>
