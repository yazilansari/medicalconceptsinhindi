...
<div class="blog-post blog-single sidebar">
	<div class="dlab-post-info">
		<div class="dlab-post-meta">
			<ul>
				<li class="post-author"><span>by</span> <a href="#">Dr Satish Kumar</a></li>
				<li class="post-category">in 
					<a href="javascript:void(0);">Acute kidney injusy, </a><!--  <a href="javascript:void(0);">fashion</a> --></li>
					<a href="javascript:void(0);">Acute renal failure, </a><!--  <a href="javascript:void(0);">fashion</a> --></li>
				<li class="post-date">at <span>20th Mar,2020</span></li>
			</ul>
		</div>
		<h2 class="title">Acute Kidney Injury</h2>
		<div class="dlab-post-media">
			<iframe width="100%" height="315" src="https://www.youtube.com/embed/lJxU1c8eV18" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<div class="author-profile-info widget">
	<div class="author-profile-pic">	
		<a href="javascript:void(0);">
			<img src="images/satish-kumar.jpg" alt="Profile Pic" width="130" height="130">
		</a>
	</div>
	<div class="author-profile-content">
		<h6 class="title">Dr Satish Kumar</h6>
			...
			<li class="comment">
				<div class="comment-body">
					<div class="comment-author vcard"> 
						...
						<cite class="fn">Sunil Sharma</cite> 
						<span class="says">says:</span> 
						 <div class="comment-meta"> <a href="javascript:void(0);">OCT 6TH, 2021</a> </div>
						<div class="reply"> <a href="javascript:void(0);" class="comment-reply-link">Reply</a> </div>
					</div>
					<div class="comment-content">
						<p>Good presentation but background noise is disturbing</p>
					</div>
				</div>
				<ol class="children">
					<li class="comment odd parent">
						<div class="comment-body">
							<div class="comment-author vcard"> 
								<img  class="avatar photo" src="images/author-img/pic3.jpg" alt=""> 
								<cite class="fn">Amar Deep Singh</cite> 
								<span class="says">says:</span> 
								 <div class="comment-meta"> <a href="javascript:void(0);">AUG 1ST, 2020</a> </div>
								<div class="reply"> <a href="javascript:void(0);" class="comment-reply-link">Reply</a> </div>
							</div>
							<div class="comment-content">
								<p>Great initiative sir....</p>
							</div>
						</div>
					</li>
				</ol>
