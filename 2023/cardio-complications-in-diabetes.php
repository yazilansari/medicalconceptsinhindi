							...
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										...
										<!-----
										<li class="post-category">in <a href="javascript:void(0);">Diet,</a>
											 <a href="diet-in-diabetes.php">Diabetes</a></li>
										<li class="post-date">at <span>1 Oct, 2019</span></li>---->
									</ul>
								</div>
								<h2 class="title">Cardio Complications in Diabetes</h2>
								<div class="dlab-post-media">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/JIg1EDGJIJs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<h5>Cardio Complications in Diabetes</h5>									
									<!-- <p>What To Eat, What Not To Eat</p>
