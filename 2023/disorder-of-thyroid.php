						...
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										...
										<li class="post-category">in 
											<a href="javascript:void(0);">Thyroid, </a>
											 <a href="javascript:void(0);">Hypothyroidism, </a>
											 <a href="javascript:void(0);">Hypothyroidism, </a>
										</li>
										<li class="post-date">at <span>  6th Feb,2021</span></li>
									</ul>
								</div>
								<h2 class="title">Disorders Of Thyroid Gland: Early Recognition And Management</h2>
								<div class="dlab-post-media">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/RCZjrkSmHvE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
								...
								<div class="dlab-post-text text">
									...
									<h5 class="mb-2">Disorders Of Thyroid Gland: Early Recognition And Management</h5>
