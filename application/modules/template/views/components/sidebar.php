    ...
    <aside id="leftsidebar" class="sidebar" >
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li <?php echo ($this->uri->uri_string() == 'App_vision/index') ? 'active' : '';?>>
                ...
                <li class="<?php echo ($this->uri->uri_string() == 'category/lists') ? 'active' : '';?>">
                    <a href="<?php echo base_url("category/lists?t=$timestamp") ?>">
                    <i class="material-icons">public</i>
                    <span>Category</span>
                    </a>
                </li>
                 <li class="<?php echo ($this->uri->uri_string() == 'category/lists_new') ? 'active' : '';?>">
                    <a href="<?php echo base_url("category/lists_new?t=$timestamp") ?>">
                    <i class="material-icons">public</i>
                ...
                <li class="<?php echo ($this->uri->uri_string() == 'subcategory/lists') ? 'active' : '';?>">
                ...
                <li class="<?php echo ($this->uri->uri_string() == 'comments/lists') ? 'active' : '';?>">
