...
<tr>
	...
	<td>
		<?php if($record->is_approved=='0' || $record->is_approved==''){?>
			<a href="javascript://" data-id="<?php echo $id;?>" data-type="<?php echo $record->is_approved;?>" data-action="new" class="comment_approve btn btn-success m-t-15 waves-effect"><i class="material-icons">done_outline</i> Approve</a>
		<?php }else if($record->is_approved=='1'){?>
			<a href="javascript://" data-id="<?php echo $id;?>" data-type="<?php echo $record->is_approved;?>" data-action="new" class="comment_approve btn btn-danger m-t-15 waves-effect"><i class="material-icons">clear</i> Disapprove</a>
		<?php }?>
	</td>
</tr>
<?php $i++;  } ?>
