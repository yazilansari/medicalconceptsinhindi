							...
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										...
										<li class="post-date">at <span> 8th Apr,2019</span></li>
									</ul>
								</div>
								<h2 class="title">मिर्गी</h2>
								<div class="dlab-post-media">
									<img src="images/blog/blog-lg/rakesh19.jpg">
								...
								<div class="dlab-post-text text">
									...
									<h5 class="mb-2">मिर्गी</h5>
									<p class="mb-3">By Dr Rakesh</p>
						...
						<div class="author-profile-info widget">
							<div class="author-profile-pic">	
								<a href="javascript:void(0);">
									<img src="images/rakeshkumar.jpg" alt="Profile Pic" width="130" height="130">
								</a>
							</div>
							<div class="author-profile-content">
								<h6 class="title">Dr Rakesh Kumar</h6>
