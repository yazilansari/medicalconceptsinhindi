						...
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										...
										<li class="post-category">in 
											<a href="javascript:void(0);">Adrenal gland, </a>
											<a href="javascript:void(0);">anotomy,  </a>
											<a href="javascript:void(0);">Cushing's syndrome,  </a>
											<a href="javascript:void(0);">clinical feature, </a>
										</li>
										<li class="post-date">at <span> 13th Oct, 2022</span></li>
									</ul>
								</div>
								<h2 class="title">Cushing's Syndrome Clinical Features</h2>
								<div class="dlab-post-media maigrain">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/czvI4nL1ThQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
								...
								<div class="dlab-post-text text"> 
									...
									<h5 class="mb-2">Cushing's Syndrome Clinical Features</h5>
									<p class="mb-3">Cushing's Syndrome Clinical Features</p>
