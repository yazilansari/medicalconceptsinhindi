...
{ 
    ...
    public function get_upload_data($data_arr,$tags="",$user_type="",$start_from="",$limit=""){
    ...
    public function get_upload_data_concat($where, $user_type=''){
        ...
        if($user_type=='General'){
            ...
            $this->db->where("(ud.upload_for_user_type='BOTH' OR ud.upload_for_user_type='Student')");
        }
    ...
    function get_thumbnail_image_path($image_name,$path,$id){
        ...
        if($image_name!=""){
            ...
            if(file_exists($this->config->item('posts_thumbnail_exists').$id.'/'.$image_name)){
            $image = $image_path;
    ...
    function get_file_path($file_name,$type,$id){
       ...
       // print_r($file_name);exit;
        ...
        if($file_name!=""){
            ...
            if($type=='audio'){
                if(file_exists($this->config->item('posts_audio_exists').$id.'/'.$file_name)){
                    $file = $file_path;
...
//var_dump($this->config->item('no_image_path'));exit;
