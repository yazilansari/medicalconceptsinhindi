	...
	*/
	...
	public function get_upload_data(){
		...
		//var_dump($result_arr[$key]->upload_path);exit;
	            ...
	            $result_arr[$key]->thumbnail = $this->upload_data_model->get_thumbnail_image_path($value->thumbnail,$this->config->item('s3_posts_thumbnail_path').$value->sub_category_id.'/',$value->sub_category_id);
