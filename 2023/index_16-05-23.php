					...
					<div class="header-nav navbar-collapse collapse justify-content-left" id="navbarNavDropdown">
						...
						<ul class="nav navbar-nav">	
									...
									<div class="life-style-bx">
										...
										<div class="life-style-post text-center">
											...
											<div id="video02" class="life-style-post-bx">
												...
												<div class="viewallpage"><a href="video-medical-education.php">View All</a></div>
												<!----view-all---->
											</div>
							...
							<li>
								...
								<ul class="sub-menu">								
									<li><a href="#" data-toggle="modal" data-target="#phoneotp1">Login Membership</a></li>
									<li><a href="registration.php">Register Membership</a></li>
								</ul>
							</li>
						</ul>
					</div>
...
<!-- 	<div class="container">
				...
				<div class="col-md-12">
			  	...
			  	<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						<p class="mb-0">Khand-1</p>
						<img src="images/khand-1.jpg" alt="">
	...
	<div class="row aprillmargin m-0">
			...
			<div class="row">
			  	<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="contributoor">
						...
						<div class="item itemone">
							...
							<img src="images/aprilbook-cover.jpg" alt="">
							<!---<a href="#">Buy Now</a>---->
							<a href="ejournals-april-2023.php" class="phonemodal"></a>
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover3.jpg" alt="">
						<a href="ejournals-march-2023.php" class="phonemodal"></a>
					</div>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover.jpg" alt="">
						<a href="ejournals-feb-2023.php" class="phonemodal"></a>
					</div>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover2.jpg" alt="">
						<!-------<a href="#" class="phonemodal" data-toggle="modal" data-target="#phoneotp1"></a>------>
						<a href="ejournals-jan-2023.php" class="phonemodal"></a>
					</div>
				</div>
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover08.jpg" alt="">
						<a href="ejournals-dec-2022.php" class="phonemodal"></a>
					</div>
				</div>
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover07.jpg" alt="">
						<a href="ejournals-nov-2022.php" class="phonemodal"></a>
					</div>
				</div>
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover06.jpg" alt="">
						<a href="ejournals-oct-2022.php" class="phonemodal"></a>
					</div>
				</div>
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover05.jpg" alt="">
						<a href="ejournals-sep-2022.php" class="phonemodal"></a>
					</div>
				</div>
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<div class="bookcover bookcover1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						...
						<img src="images/book-cover04.jpg" alt="">
						<a href="ejournals-aug-2022.php" class="phonemodal"></a>
					</div>
				</div>
			</div>
			</div>
				...
				<div class="category-owl owl-carousel owl-btn-center-lr">
					...
					<div class="item">
						<div class="category-box">
							...
							<div class="category-info">
								<a href="ejournal-medical-education.php" class="category-title">E Journal</a>
							</div>
						</div>
					</div>
		...
		<div class="section-full latest-post-bx wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" >
			<div class="setResizeMargin setresize2">
