...
<div class="modal fade subscribe-modal-bx" id="readvideo" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="thankyu">
							...
							<p>To Watch Video Please register Yourself.</p>	
							<a href="#" id="ok" onclick="window.location.href='registration.php?type=aGVhbHRoIHZpZGVv'" data-dismiss="modal">Next</a>
						</div>
					</div>
				</div>				
			</div>
...
<div class="modal fade subscribe-modal-bx" id="payvideo" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content subscribe-form popupphonecss">
			<div class="modal-header">
				<div class="sub-title phonecolor">
			...
			<div class="modal-body okthanks">				
				<div class="row">
					<div class="col-md-12">
						<div class="thankyu">
							<!---<p><i class="fa fa-check-square" aria-hidden="true"></i> To Read article Please register Yourself.</p>--->
							<p>To Watch Video Please Pay Now.</p>	
							<a href="#" id="ok" onclick="window.location.href='payment.php?type=aGVhbHRoIHZpZGVv'" data-dismiss="modal">Pay Now</a>
						</div>
					</div>
				</div>				
			</div>
