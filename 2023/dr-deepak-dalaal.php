					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-12">
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								...
								<h2 class="title">Dr. Deepak Dalal</h2>
								<div class="dlab-post-media">
									<img src="images/blog/blog-lg/deepak-dalaal.jpg" class="drbipin">
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<div class="readmre1"> 
									<p class="mb-2"><a href="#" class="namedr"><b>-Dr. Deepak Dalal</b></a></p>
									<p class="mb-3 medicineed"><b class="font-22">Consultant Endocrinologist</b></p>								
