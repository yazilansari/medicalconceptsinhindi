					...
					<div class="col-md-8 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.2s; animation-name: fadeInUp;">
						<div class="row">
								...
								<div class="blog-card blog-grid overlay-post left"> 
									...
									<div class="blog-card-info">
										<div class="dlab-post-meta">
											<ul>
												<li class="post-tag"><a href="icterus.php">CASE STUDY</a></li>
											</ul>
										</div>
							...
							<div class="col-md-6 col-sm-12">
								<div class="blog-card blog-grid overlay-post left">
									<div class="dlab-post-media">
										<img src="images/category/inguinoscrotal-hernia.jpg" alt="">
									</div>
									<div class="blog-card-info">
										<div class="dlab-post-meta">
											<ul>
												<li class="post-tag"><a href="Inguinoscrotal-hernia.php">CASE STUDY</a></li>
											</ul>
										</div>
										<h4 class="title"><a href="Inguinoscrotal-hernia.php">D/D Inguinoscrotal hernia</a></h4>
									</div>
								</div>
							</div><!---1End---->
							...
							<div class="col-md-6 col-sm-12">
								<div class="blog-card blog-grid overlay-post left"> 
									<div class="dlab-post-media">
										<img src="images/category/right-sided-hydrocoel.jpg" alt="">
									</div>
									<div class="blog-card-info">
										<div class="dlab-post-meta">
											<ul>
												<li class="post-tag"><a href="hydrocoel.php">CASE STUDY</a></li>
											</ul>
										</div>
										<h4 class="title"><a href="hydrocoel.php">Right sided hydrocoel</a></h4>
									</div>
								</div>
							</div>
							<!----2End---->
