		...
		<div class="modal-content subscribe-form popupphonecss">
			<div class="modal-header phoneline">
				<div class="sub-title phonecolor">
					<h3 class="title">Login Subscription</h3>
					<!-- <p>Receive Only The Best Posts Via Email</p> -->
				</div>
			...
			<div class="modal-body">
				<form method="POST" action="handler/login_handler.php">
					<div class="row">
						<p id="incorrect_mobile" style="color: red; display: none;">This Mobile Number is Not Registered</p>
						<p id="error_while" style="color: red; display: none;">Error Occurred While Sending OTP</p>
						<div class="col-md-12">
							<div class="phnetext">
								...
								<!-----<p><a href="registration.php"><i class="fa fa-angle-double-right" aria-hidden="true"></i> New User Subscription</a></p>----->
...
<div class="modal fade subscribe-modal-bx" id="payment_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content subscribe-form popupphonecss">
			<div class="modal-header">
				<div class="sub-title phonecolor">
			...
			<div class="modal-body okthanks">				
				<div class="row">
					<div class="col-md-12">
						<div class="thankyu">
							<p><i class="fa fa-check-square" aria-hidden="true"></i> Paid Sucessfully.</p>
							<a href="#" id="ok" onclick="window.location.href='index.php'" data-dismiss="modal">Ok</a>
						</div>
					</div>
				</div>				
...
<div class="modal fade subscribe-modal-bx" id="payment_regarding" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content subscribe-form popupphonecss">
			<div class="modal-header">
				<div class="sub-title phonecolor">
			...
			<div class="modal-body okthanks">				
				<div class="row">
					<div class="col-md-12">
						<div class="thankyu">
							<p><i style="color: red;" class="fa fa-close" aria-hidden="true"></i> Payment Aborted or Payment Failure or Illegal Access Detected.</p>
							<a href="#" id="ok" onclick="window.location.href='index.php'" data-dismiss="modal">Ok</a>
						</div>
					</div>
				</div>				
