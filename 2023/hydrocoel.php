						...
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										...
										<li class="post-category">in 
											...
											<a href="javascript:void(0);">hydrocoel, </a>	
										</li>
										<li class="post-date">at <span> 8th Aug,2019</span></li>
									</ul>
								</div>
								<h2 class="title">Right Sided Hydrocoel</h2>
								<div class="dlab-post-media">									
									<img src="images/blog/blog-lg/hydrocoel.jpg">
								...
								<div class="dlab-post-text text">
									...
									<h5 class="mb-2">Right Sided Hydrocoel</h5>
									<p class="mb-3">Right Sided Hydrocoel</p>
