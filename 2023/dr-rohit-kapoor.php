						...
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										<li class="post-author"><span>by</span> <a href="#">Dr Rohit Kapoor</a></li>
										<li class="post-category">in <a href="javascript:void(0);">Diabetes,</a><!--  <a href="javascript:void(0);">fashion</a> --></li>
										<li class="post-date">at <span>24th Sep,2019</span></li>
									</ul>
								</div>
								<h2 class="title">TIPS TO CONTROL BLOOD PRESSURE</h2>
								<div class="dlab-post-media">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/nGNmoTfuh0o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<h5>Tips To Control Blood Pressure</h5>
									<p>Recognizing Hypertension And Benefits Of Controlling It</p>
						...
						<div class="author-profile-info widget">
							<div class="author-profile-pic">	
								<a href="javascript:void(0);">
									<img src="images/rohit-kapoor.jpg" alt="Profile Pic" width="130" height="130">
								</a>
							</div>
							<div class="author-profile-content">
								<h6 class="title">Dr Rohit Kapoor</h6>
