				...
				<?php echo form_open("$controller/remove",array('id'=>'frm_delete', 'name'=>'frm_delete')); ?>
					<div class="form-group">
						...
						<div class="col-md-3 text-left subcategory">
						    ...
						    <a class="btn btn-primary waves-effect sort_posts  pull-left" href="javascript://" data-type="ajax-loader" style="float: right;margin-left: 5px;" data-toggle="modal" data-target="#uploadbox" ><i class="material-icons">book</i> <span>Sort Folder</span></a>                     
						</div>                          
                	</div>
...
<div class="modal fade in" id="uploadbox" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php include_once 'sort_folder_lists.php'; ?>
