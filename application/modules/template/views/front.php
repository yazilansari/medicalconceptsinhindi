...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content = "MCH - Medical Concepts in Hindi By Dr Pankaj Agarwal">
        <meta name="google-site-verification" content="3NZX4xZOPkY0iO96qqJOTdKgnprMqvWZNjAkvIhDUSM" />
        ...
        <!-- Single Post -->
            <div class="container-fluid no-left-padding no-right-padding single-post">
                ...
                <?php endif;?>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center" style="padding-bottom:50px;"><img src="<?php echo base_url() ?>front_assets/images/MCH_Banner_1349x500px.jpg"></div>
                        <!-- Content Area -->
                            <?php
                                if(!isset($module)){
