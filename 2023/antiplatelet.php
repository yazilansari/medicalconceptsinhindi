						...
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										<li class="post-author"><span>by</span> <a href="#">Dr Mukul Misra</a></li>
										<li class="post-category">in <a href="javascript:void(0);">CAD, </a>
											<a href="javascript:void(0);">Coronary artery disease, </a>
											<a href="javascript:void(0);">Antiplatelet therapy, </a>
										</li>
										<li class="post-date">at <span>18 Oct, 2021</span></li>
									</ul>
								</div>
								<h2 class="title">Antiplatelet Therapy</h2>
								<div class="dlab-post-media">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/MrQcRNtMHvY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<p>Clotting In Coronary Arteries: Problem And Solutions</p>
						...
						<div class="author-profile-info widget">
							<div class="author-profile-pic">	
								<a href="javascript:void(0);">
									<img src="images/mukul-misra.jpg" alt="Profile Pic" width="130" height="130">
								</a>
							</div>
							<div class="author-profile-content">
								<h6 class="title">Dr Mukul Misra</h6>
