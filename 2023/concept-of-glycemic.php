						...
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										<li class="post-author"><span>by</span> <a href="#">Dr. Prabhat Agarwal</a></li>
										<!-------
										<li class="post-category">in 
											<a href="javascript:void(0);">Adrenal glands,  </a>
											<a href="javascript:void(0);">Anatomy,  </a>
								...
								<h2 class="title">Concept of Glycemic Index and its Implications in Clinical Practice</h2>
								<div class="dlab-post-media maigrain">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/rvw-6c7CokM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
								...
								<div class="dlab-post-text text">
									...
									<h5 class="mb-2">Concept of Glycemic Index and its Implications in Clinical Practice</h5>
									<p class="mb-3">By Dr. Prabhat Agarwal</p>
						...
						<div class="author-profile-info widget">
							<div class="author-profile-pic">	
								<a href="javascript:void(0);">
									<img src="images/prabhat-agarwal.jpg" alt="Profile Pic" width="130" height="130">
								</a>
							</div>
							<div class="author-profile-content">
								<h6 class="title">Dr. Prabhat Agarwal</h6>
