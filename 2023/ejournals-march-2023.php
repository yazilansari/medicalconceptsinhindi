				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 allebooks">
						<div class="bookcover e-books headline">
							<h4>Punarnava March 2023</h4>
							<hr>
							<?php if(!isset($_SESSION['reg_id']) && empty($_SESSION['reg_id'])) { ?>
							<!----<a href="https://medicalconceptsinhindi.in/2023/registration.php?type=ZWpvdXJuYWw=" class="registersubscribe" data-toggle="modal" data-target="#phoneotp1">Register For Membership</a>---->
							...
							<?php } else { ?>
							<!-- <a href="#" class="registersubscribe" onclick="paynow('ejournal-march-2023');">Pay Now</a> -->
							<a href="ebook/2023/Mar" class="registersubscribe">View Book</a>
							<?php } } ?>
							<div class="pdfindex">
								<?php if(!isset($_SESSION['reg_id']) && empty($_SESSION['reg_id'])) { ?>
								<p>	
									<a href="#" data-toggle="modal" data-target="#readarticle">
										<img src="images/ejournals/15-march-2023_Page_1.jpg">
										<img src="images/ejournals/15-march-2023_Page_2.jpg">
									</a>
								</p>
								<?php } else { ?>
								<p>	
