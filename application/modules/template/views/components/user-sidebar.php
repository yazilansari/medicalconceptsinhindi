            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li><a href="<?php echo base_url() ?>afm/logout"><i class="material-icons">input</i>Sign Out</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <ul class="list">
                ...
                <!-- <li <?php echo ($mainmenu == 'report') ? 'class="active"': ''; ?>>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li <?php echo ($menu == 'patient_wise_drug_count') ? 'class="active"': ''; ?>>
                            <a href="<?php echo base_url("reports/view/type/patient_wise_drug_count?t=$timestamp") ?>">Patient Wise Drug Count</a>
                        </li>
                    </ul>
                </li> -->
