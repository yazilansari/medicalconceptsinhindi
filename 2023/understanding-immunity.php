					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-12">
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										<li class="post-author"><span>by</span> <a href="#">Dr (Prof.) Narsingh Verma MD</a></li>
										<!-----
								...
								<h2 class="title">Understanding Immunity </h2>
								<div class="dlab-post-media maigrain">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/ZcG8qI0CrFE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
								...
								<div class="dlab-post-text text">
									...
									<h5 class="mb-2">Understanding Immunity</h5>
									<p class="mb-3">By Dr (Prof.) Narsingh Verma MD</p>
						...
						<div class="author-profile-info widget">
							...
							<div class="author-profile-content">
								<h6 class="title">Dr. (Prof.) Narsingh Verma MD</h6>
