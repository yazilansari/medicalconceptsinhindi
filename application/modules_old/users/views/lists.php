		...
		<div class="card">
			<div class="header">
				...
				<ul class="header-dropdown m-r--5">
					<li class="dropdown">
						<a class="btn btn-primary waves-effect" href="<?php echo base_url("$controller/add/type/$menu") ?>">Add <?= strtoupper($menu) ?></a>
						...
						<ul class="dropdown-menu pull-right">
							<li><a href="<?php echo base_url("$controller/add/type/$menu") ?>">Add <?= strtoupper($menu) ?></a></li>
            ...
            <div class="modal-body">
				...
				<div class="form-group form-float">
					<div class="form-line focused">
						<input type="hidden" name="users_type" value="<?php echo $users_type ?>">
