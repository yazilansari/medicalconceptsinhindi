					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-12">
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								...
								<h2 class="title">Diabetic Food Exchanges Part 1 Variety in Oils & Fats </h2>
								<div class="dlab-post-media">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/gDqBp3slBrM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
						...
						<div class="author-profile-info widget">
							...
							<div class="author-profile-content">
								<h6 class="title">Dr. Pankaj Agarwal</h6>
