						...
						<div class="blog-post blog-single sidebar">
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										<li class="post-author"><span>by</span> <a href="#">Dr KP Saini</a></li>
										<li class="post-category">in 
											<a href="javascript:void(0);">Pneumonia, ,</a>
											 <a href="javascript:void(0);">Chest physiotherapy, </a>
											 <a href="javascript:void(0);">Covid, </a>
											 <a href="javascript:void(0);">Lung capacity,</a>
										</li>
										<li class="post-date">at <span>17 Oct, 2021</span></li>
									</ul>
								</div>
								<h2 class="title">LUNG EXERCISES FOR COVID PATIENTS</h2>
								<div class="dlab-post-media">
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/MKmACbq9j3I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<h5>Lung Exercises For Covid Patients</h5>
									<p>Lung Exercises After Recovery From Covid Pneumonia To Increase Lungs Capacity</p>
