...
<form action="<?php echo base_url("App_vision/update_app_vision"); ?>" method="post" >
    <h5 class="text-light" style="font-weight:bolder">App Vision</h5>
    <textarea class="form-control app_vision" name="app_vision" cols="100" rows="10" placeholder="App Vision"><?php echo $visions->app_vision?></textarea>
