							...
							<div class="dlab-post-info">
								<div class="dlab-post-meta">
									<ul>
										...
										<li class="post-category">in <a href="javascript:void(0);">Punarnava, E-Journal, volume 2,
										 </a><!--  <a href="javascript:void(0);">fashion</a> --></li>
										<li class="post-date">at <span>  16th Sep, 2022</span></li>
									</ul>
								</div>
								<h2 class="title">Punarnava E-journal (volume 2)</h2>
								<div class="dlab-post-media">
									<img src="images/blog/blog-lg/pic3.jpg">
									<!-- <a href="javascript:;"><img src="images/blog/large/pic1.jpg" alt=""></a> -->
								</div>
								<div class="dlab-post-text text">
									<div class="readmre1"> 
									<h5>Punarnava E-Journal (Volume 2)</h5>	
									<p>Punarnava E-journal (Volume 2) Kindly See All Contents In The E-journal Section</p>
										...
										<ol class="children">
											<li class="comment odd parent">
												<div class="comment-body">
													<div class="comment-author vcard"> 
														<img  class="avatar photo" src="images/kusum-lata.jpg" alt=""> 
														<cite class="fn">Dr. Om Gurjar</cite> 
														<span class="says">says:</span> 
														 <div class="comment-meta"> <a href="javascript:void(0);">Jun 21st, 2020</a> </div>
														<div class="reply"> <a href="javascript:void(0);" class="comment-reply-link">Reply</a> </div>
													</div>
													<div class="comment-content">
														<p>Superb</p>
