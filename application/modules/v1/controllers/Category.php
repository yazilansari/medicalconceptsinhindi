...
class Category extends MY_Controller
{
	...
	public function get_category()
	{
		...
		//$flag = true;
		$message = "";
		$users_type = isset($data['user_type']) ? ucfirst($data['user_type']) : "General";
		...
		if (!empty($resultant_arr)) {
			...
			$this->response['users_type'] = $users_type;
		} else {
			$this->response['code'] = 400;
			$this->response['message'] = "Please update your Application and try again!!!";
			$this->error['message'] = array("message" => "Please update your Application and try again!!!");
			$this->response['users_type'] = $users_type;
		}
	...
	//just for testing to see if a response is given
	public function all_event_data_post()
	{
		...
		if (!empty($result_data)) {
			...
			$this->response['code'] = 200;
			$this->response['message'] = "No event data found !!!";
	...
	public function past_event_data_post()
	{
		...
		if (!empty($result_data)) {
			...
			$this->response['code'] = 200;
			$this->response['message'] = "No past event data found !!!";
			$this->response['status'] = "0";
			$this->error = array("message" => "Sub Category for this Category does not exists!!!");
		}
		$this->sendResponse();
