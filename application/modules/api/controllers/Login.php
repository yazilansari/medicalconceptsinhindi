	...
	public function get_contributors(){
		...
		if($flag){
			...
			foreach ($result_data as $key => $value) {
				...
				$result_arr[$key]['contributors_image'] ='http://www.medicalconceptsinhindi.com/uploads/assets/uploaded_data/contributors_img/'.$value->contributors_image; /*get_contributors_image_path($value->contributors_image);*/
	...
	*/
	public function contributors_details(){
		...
		if($flag){
			...
			$result_arr['contributors_image'] = "http://www.medicalconceptsinhindi.com/uploads/assets/uploaded_data/contributors_img/".$result_data->contributors_image;
