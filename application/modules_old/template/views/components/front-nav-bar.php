                    ...
                    <div class="dropdown-menu megamenu">
                        <div class="col-md-2 col-sm-12 megamenu-categories">
                            <ul class="nav nav-tabs" role="tablist">
                                <?php if(!empty($category)){ foreach($category as $c){ if($main->main_category_id == $c->main_category_id){ ?>
                        ...
                        <div class="col-md-10 col-sm-12 col-xs-12 megamenu-post tab-content">
                            <?php foreach($upload_data as $key => $ud) { if($main->main_category_id==$key) {?>
                                <?php foreach($ud as $key1 => $u1){ $i=0;?>
                                    <div role="tabpanel" class="tab-pane <?php if($main->main_category_id==$key && $key1==1){echo 'active';}?>" id="design-<?php echo $key;?>-<?php echo $key1;?>">
                                        <?php foreach($u1 as $key2 => $u2){ $i++;?>
                                            <div class="col-md-3 col-sm-4 col-xs-4">
                                                <div class="type-post">
                                                    <div class="entry-cover"><a href="<?php echo base_url().'post/'.$u2->meta_slug;?>"><img src="<?php echo $u2->thumbnail_path;?>" alt="<?php echo $u2->upload_type;?>" style="width: 205px; height: 205px;"/></a></div>
                                                    <h3 class="entry-title"><a href="<?php echo base_url().'post/'.$u2->meta_slug;?>"><?php echo $u2->upload_title;?></a></h3>
                                                    <?php if($i==3){ $v2='';
                                                        if($u2->category_name=='Text'){$v2='text';}
                                                        if($u2->category_name=='Audio'){$v2='audio';}
                                                        if($u2->category_name=='Video'){$v2='video';}
                                                        if($u2->category_name=='Case Study'){$v2='caseStudy';}?>
                    ...
                    <div class="navbar-form navbar-right navbar-form-search" role="search">
                        ...
                        <div class="search-form-container hdn" id="search-input-container">
                            <div class="search-input-group">
                                <button type="button" class="btn btn-success" id="hide-search-input-container"><span class="glyphicon glyphicon-option-horizontal"
