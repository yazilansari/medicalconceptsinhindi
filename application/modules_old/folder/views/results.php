<?php $i = 1; if(sizeof($collection)) : foreach ($collection as $record) { $id = $record->folder_id; ?>
<tr>
	<td>
	...
	<td><?php echo $record->folder_name ?></td>
	<!-- <td><?php echo $record->main_category_name ?></td> -->
